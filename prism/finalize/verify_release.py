    ...
    release_rows = _rows(
        {
            ...
            "executive_summary": str(target / "executive_summary.md"),
            ...
            "final_speaker_script": str(target / "final_speaker_script.md"),
            "one_minute_pitch": str(target / "one_minute_pitch.md"),
            "three_minute_pitch": str(target / "three_minute_pitch.md"),
            "qa_cheat_sheet": str(target / "qa_cheat_sheet.md"),
            "final_wrapup_report": str(target / "final_wrapup_report.md"),
            "submission_checklist": str(target / "submission_checklist.md"),
            "demo_day_checklist": str(target / "demo_day_checklist.md"),
            "final_artifact_index": str(target / "final_artifact_index.md"),
            "synthesis_summary": str(target / "synthesis_summary.json"),
            "chart_benchmark_overview": str(target / "charts" / "benchmark_overview.png"),
            "chart_adversarial_router_comparison": str(target / "charts" / "adversarial_router_comparison.png"),
            "chart_human_eval_overview": str(target / "charts" / "human_eval_overview.png"),
            "figure_architecture_diagram": str(target / "figures" / "architecture_diagram.png"),
            "figure_ras_family_overview": str(target / "figures" / "ras_family_overview.png"),
